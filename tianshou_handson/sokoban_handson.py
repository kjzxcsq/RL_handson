...
train_envs = ts.env.DummyVectorEnv([lambda: gym.make('Sokoban-v0') for _ in range(8)])
test_envs = ts.env.DummyVectorEnv([lambda: gym.make('Sokoban-v0') for _ in range(100)])
